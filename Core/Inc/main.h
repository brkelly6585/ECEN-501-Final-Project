...
/* Exported macro ------------------------------------------------------------*/
/* USER CODE BEGIN EM */
#define COMPUTATION_TEMPERATURE_TEMP30_TEMP110(TS_ADC_DATA)(((( ((int32_t)((TS_ADC_DATA * VDDA_APPLI) / VDDA_TEMP_CAL)- (int32_t) *TEMP30_CAL_ADDR)) * (int32_t)(110 - 30)) / (int32_t)(*TEMP110_CAL_ADDR - *TEMP30_CAL_ADDR)) + 30);
/* USER CODE END EM */
